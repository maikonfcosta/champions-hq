        ...
        {activeTab === 'official' && (
          <div className="animate-fade-in" style={{ padding: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
              <button 
                onClick={() => { setPdfUrl('https://github.com/maiki/marvel-champions-helper/releases/download/docs/marvel_champions_th_learn_to_play_142802.pdf'); setPdfTitle('Aprenda a Jogar'); }} 
              ...
              <button 
                onClick={() => { setPdfUrl('https://github.com/maiki/marvel-champions-helper/releases/download/docs/marvel_champions_th_referencia_de_regras_142911.pdf'); setPdfTitle('Referência de Regras'); }} 
                className="glass-panel" 
                style={{ display: 'flex', flexDirection: 'column', padding: '24px', border: 'none', background: 'rgba(255,255,255,0.05)', textAlign: 'left', cursor: 'pointer', transition: 'all 0.3s' }}
              >
              ...
              <button 
                onClick={() => { setPdfUrl('https://github.com/maiki/marvel-champions-helper/releases/download/docs/marvel_champions_th_guia_de_referencia_pt_br_268594.pdf'); setPdfTitle('Guia de Referência PT-BR'); }} 
                className="glass-panel" 
                style={{ display: 'flex', flexDirection: 'column', padding: '24px', border: 'none', background: 'rgba(255,255,255,0.05)', textAlign: 'left', cursor: 'pointer', transition: 'all 0.3s' }}
              >
